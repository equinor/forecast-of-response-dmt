...
class Form extends Component {
  constructor(props) {
    ...
    this.entities = {
      simulation: new Entity({ document: props.document.simulation }),
    }
  }
  ...
  updateDoc = () => {
    ...
    this.props.document.simulation = this.entities.simulation.document
    ...
    return (
      <form>
        <Box width="60%">
          ...
          <Box m={2} />
          <DocForm entity={this.entities.simulation} />
          <Box m={3} />
          <Button
            variant="contained"
            size="large"
...
export { sceForm as SRSSceSimulationForm }
